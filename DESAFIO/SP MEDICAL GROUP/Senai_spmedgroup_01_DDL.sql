...
(
	...
	Cnpj			CHAR(15) UNIQUE NOT NULL,  -- CHAR USADOS PARA VALORES QUE NÃO IRÃO MUDAR
...
(
	...
	IdUsuario			INT FOREIGN KEY REFERENCES Usuarios(IdUsuario),
	Nome				VARCHAR(200),					-- VARCHAR USADO PARA TEXTOS QUE PODEM MUDAR
	Rg					INT UNIQUE NOT NULL,			-- INT COM UNIQUE RETORNA UM NUMERO INTEIRO QUE NÃO IRÁ SE REPETIR
	Telefone			INT NOT NULL,					-- INT NESSE CASO RETORNA MULTIVALORES
	Cpf					INT UNIQUE NOT NULL,			-- INT COM UNIQUE RETORNA UM NUMERO INTEIRO QUE NÃO IRÁ SE REPETIR
);
GO
